...
int main(void)
{
	...
	while(1)
	{
		switch(config_cycle)
		{
			case 0:
			{
				SystemClockConfigPllHSE(SYS_CLOCK_FREQ_50_MHZ);
			}
			break;
			case 1:
			{
				SystemClockConfigPllHSE(SYS_CLOCK_FREQ_84_MHZ);
			}
			break;
			case 2:
			{
				SystemClockConfigPllHSE(SYS_CLOCK_FREQ_120_MHZ);
			}
			break;
			default:
			{
